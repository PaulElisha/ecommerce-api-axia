...
async function main() {
    ...
    const privateKey: string = "private keu";
    const rpcUrl: string = "base-rpc-url";
    const walletAddress: string = "wallet address";

    const UNISWAP_ROUTER_ADDRESS: string = "0xA324880f884036E3d21a09B90269E1aC57c7EC8a";
    const UNISWAP_FACTORY_ADDRESS: string = "0x7431A23897ecA6913D5c81666345D39F27d946A4";
    ...
    const multicallSwap = new MulticallSwap(signer, UNISWAP_ROUTER_ADDRESS, UNISWAP_FACTORY_ADDRESS);
